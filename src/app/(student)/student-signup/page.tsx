...
import bgImage from "../../../../public/assets/authImages/student.jpg";
...
const validateStudentForm = (data: StudentFormData) => {
  ...
  if (!data.age || parseInt(data.age) < 1) errors.age = "Valid age is required";
